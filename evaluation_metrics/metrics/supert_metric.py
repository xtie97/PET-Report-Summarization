...
import gin
from metrics.sentence_transformers import SentenceTransformer
from metrics.metric import Metric
from metrics.supert_utils import parse_documents, get_all_token_vecs, build_pseudo_ref, get_sbert_score, get_token_vecs
...
class SupertMetric(Metric):
    def __init__(self, ref_metric='top5', sim_metric='f1'):
        self.bert_model = SentenceTransformer('all-mpnet-base-v2') 
        # all-mpnet-base-v2  slow but accurate 
        # all-MiniLM-L6-v2   fast but not accurate in tested dataset
