...
def get_all_token_vecs(model, sent_info_dict):
    ...
    #all_vecs = model.encode(all_sents, output_value='sentence_embedding', convert_to_tensor=True)
    #all_vecs = model.encode(all_sents, output_value='token_embeddings')
    #all_tokens = model.encode(all_sents, output_value='input_ids')
