...
def preprocess(model_id, encoder_max_full, encoder_max_response, save_dataset_path):
    ...
    def generate_and_tokenize_prompt(data_point):
        ...
        #print('instruction, response, full', user_prompt_len, user_response_len, len(tokenized_full_prompt['input_ids']))
...
if __name__ == "__main__":
    model_id = "facebook/opt-1.3b" # Hugging Face Model Id 
    # 125m, 350m, 1.3b, 2.7b
    ...
    --bf16 False \
    --master_port=25689 \
    --deepspeed configs/ds_config.json') # configs/ds_config_bf16.json for bf16 training 
